    ...
    */
    ...
    private void init(){
        ...
        try {
            ...
            System.out.println("Anmeldung bei Twitter fehlgeschlagen. Meldung: " + ae.getLocalizedMessage());
        }
    }
    ...
    */ 
    public void updateStatus(String statusText) throws Exception {
        ...
        try{
            ...
            System.out.println("Tweet posten fehlgeschlagen. Meldung: " + ae.getLocalizedMessage());
            
            // Fehler an aufrufende Methode zurück geben
            throw new Exception("Tweet posten fehlgeschlagen", ae);
        }
    }
}
